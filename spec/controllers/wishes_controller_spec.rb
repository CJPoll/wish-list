...
RSpec.describe WishesController, :type => :controller do
	...
	describe "GET index" do
		it "assigns all the user's wishes as @wishes" do
			wish1 = FactoryGirl.create(:wish, user: @user)
			FactoryGirl.create(:wish)
			get :index, {}, valid_session
			expect(assigns(:wishes)).to eq([wish1])
		end
	end
